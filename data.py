...
class ImageFolder(datasets.DatasetFolder):
    ...
    def find_subclasses(self, nclass=100, phase=0, seed=0):
        ...
        if seed == 0:
            ...
            elif self.spec == 'part1':
                file_list = './misc/class_part1.txt'
            elif self.spec == 'part2':
                file_list = './misc/class_part2.txt'
            elif self.spec == 'part3':
                file_list = './misc/class_part3.txt'
            elif self.spec == 'part4':
                file_list = './misc/class_part4.txt'
            elif self.spec == '100':
    ...
    def __getitem__(self, index):
        ...
        #print(len(self.original_targets))
